...
$_lang["modx_charset_message"] = 'Выберите кодировку страниц сайта. Помните, что MODX тестировался не на всех кодировках. Для большинства языков подходит кодировка UTF-8.';
$_lang["modx_charset_title"] = 'Кодировка:';
...
$_lang["clean_uploaded_filename_title"] = 'Использовать транслитерацию при загрузке файлов.';
...
$_lang["cache_default_message"] = 'Выберите \'Да\', чтобы новые ресурсы после создания кэшировались по умолчанию.';
$_lang["cache_default_title"] = '\'Кэшируемый\' по умолчанию:';
$_lang["auto_menuindex_message"] = 'Выберите \'Да\', для автоматического увеличения позиции в меню для новых ресурсов.';
$_lang["auto_menuindex_title"] = '\'Индексация меню\' по умолчанию:';
$_lang["publish_default_message"] = 'Выберите \'Да\', чтобы новые ресурсы после создания публиковались по умолчанию.';
$_lang["publish_default_title"] = '\'Публиковать\' по умолчанию:';
$_lang["search_default_message"] = 'Выберите \'Да\', чтобы новые ресурсы после создания были доступны для поиска по умолчанию.';
$_lang["search_default_title"] = '\'Доступен для поиска\' по умолчанию:';
$_lang["default_template_message"] = 'Выберите шаблон, который будет применяться к новым ресурсам по умолчанию. При редактировании ресурса вы можете установить любой шаблон.';
$_lang["default_template_title"] = 'Шаблон по умолчанию:';
$_lang["auto_template_logic_title"] = 'Автоматическое назначение шаблона';
$_lang["auto_template_logic_message"] = 'Шаблон, назначаемый новым ресурсам:';
...
$_lang["allow_duplicate_alias_message"] = 'Выберите \'Да\', чтобы разрешить повторение псевдонимов. <b>ПРИМЕЧАНИЕ:</b> этот параметр должен использоваться вместе с включенной функцией \'Использовать вложенные URL\'.';
$_lang["allow_duplicate_alias_title"] = 'Разрешить повторяющиеся псевдонимы:';
...
$_lang["error_page_message"] = 'Введите ID ресурса, который вы хотите использовать как страницу ошибки (404 - ресурс не найден). <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован';
$_lang["error_page_title"] = 'Страница ошибки \'404\':';
...
$_lang["friendly_alias_urls_message"] = 'Если сайт использует дружественные URL, и ресурс имеет псевдоним, то при включении этого параметра URL ресурса будет иметь вид: \'http://mysite.com/псевдоним\'. Если определены суффикс (например \'.html\') и/или префикс (например \'page-\') дружественных URL, адрес страницы будет следующий: \'http://mysite.com/page-псевдоним.html\'. Если не заданы псевдонимы, суффиксы и префиксы, MODX сгенерирует такой URL: \'http://mysite.com/2\', где 2 - ID ресурса.';
$_lang["friendly_alias_urls_title"] = 'Использовать псевдонимы в URL:';
$_lang["friendly_urls_message"] = 'Данный параметр позволяет разрешить использование дружественных URL на сайте. Помните, что данная возможность доступна лишь тогда, когда MODX работает на сервере Apache с установленным mod_rewrite; кроме того, необходимо изменить файл .htaccess. Для информации по подробным настройкам посмотрите файл .htaccess, входящий в дистрибутив MODX.';
$_lang["friendly_urls_title"] = 'Использовать дружественные URL:';
$_lang["friendly_url_prefix_message"] = 'Здесь вы можете указать особый префикс для дружественных URL. Например, если в качестве такого префикса вы укажете слово \'page\', то URL типа /index.php?id=2 будет преобразован в /page2.html (в качестве суффикса URL здесь выступает \'.html\').';
$_lang["friendly_url_prefix_title"] = 'Префикс для дружественных URL:';
$_lang["friendly_url_suffix_message"] = 'Здесь вы можете указать суффикс для дружественных URL. Указав \'.html\', вы добавите .html ко всем дружественным URL.';
$_lang["friendly_url_suffix_title"] = 'Суффикс для дружественных URL:';
...
$_lang["manager_language_message"] = 'Выберите язык системы управления сайтом.';
$_lang["manager_language_title"] = 'Язык системы управления:';
...
$_lang["manager_theme_title"] = 'Шаблон системы управления:';
...
$_lang["number_of_logs_message"] = 'Выберите количество записей протокола на странице при его просмотре.';
$_lang["number_of_logs_title"] = 'Количество записей протокола:';
$_lang["number_of_messages_message"] = 'Выберите количество сообщений на странице при их просмотре.';
$_lang["number_of_messages_title"] = 'Количество сообщений:';
$_lang["none"] = 'Нет';
$_lang["number_of_results_message"] = 'Введите количество элементов, отображаемых в списках и результатах поиска.';
$_lang["number_of_results_title"] = 'Количество результатов:';
...
$_lang["php_version_check"] = 'Система MODX работает с PHP версии 4.4.2 или выше. Пожалуйста, обновите PHP';
$_lang["plugin"] = 'Плагин';
...
$_lang["use_browser_message"] = 'Выберите \'Да\', чтобы включить браузер файлов. Это позволит менеджерам загружать файлы (изображения, медиа-файлы) на сервер.';
$_lang["use_browser_title"] = 'Включить файл-менеджер:';
...
$_lang["remember_last_tab_title"] = 'Запоминать вкладки';
...
$_lang["server_offset_time_message"] = 'Выберите поправку (количество часов) между временем на месте вашего пребывания и на месте нахождения сервера. Текущее время на сервере - <b>[%s]</b>, текущее время на сервере с учетом временной поправки - <b>[%s]</b>.';
$_lang["server_offset_time_title"] = 'Разница во времени:';
...
$_lang["signupemail_message_message"] = 'Здесь вы можете создать сообщение, которое будет отсылаться менеджерам, когда создается учетная запись нового менеджера. Письмо должно содержать имя пользователя и пароль. <br /><b>ПРИМЕЧАНИЕ.</b> Следующие \'поля вывода\' отобразят соответствующие данные при отправлении письма: <br /><br />[+sname+] - название сайта, <br />[+saddr+] - e-mail адрес сайта, <br />[+surl+] - адрес (URL) сайта, <br />[+uid+] – имя пользователя или id пользователя, <br />[+pwd+] - пароль пользователя, <br />[+ufn+] - полное имя пользователя. <br /><br /><b>Убедитесь, что в сообщении присутствуют поля [+uid+] и [+pwd+], иначе пользователь не узнает свои имя пользователя и пароль</b>';
$_lang["signupemail_message_title"] = 'Регистрация менеджера:';
$_lang["site"] = 'Сайт';
$_lang["site_schedule"] = 'Расписание сайта';
$_lang["site_name_message"] = 'Введите заголовок вашего сайта.';
$_lang["site_name_title"] = 'Заголовок сайта:';
$_lang["site_slogan_message"] = 'Введите слоган Вашего сайта. В шаблоне - [(site_slogan)]';
$_lang["site_slogan_title"] = 'Слоган сайта';
$_lang["site_start_message"] = 'Введите ID ресурса, который вы хотите использовать как стартовую (домашнюю) страницу. <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован';
$_lang["site_start_title"] = 'Первая страница:';
$_lang["site_status_message"] = 'Выберите \'Онлайн\' для опубликования вашего сайта. Если вы выберете \'Оффлайн\', посетители сайта увидят сообщение о недоступности сайта и не смогут  просмотреть сам сайт.';
$_lang["site_status_title"] = 'Статус сайта:';
$_lang["site_unavailable_message_title"] = 'Сообщение о недоступности сайта:';
$_lang["site_unavailable_message_message"] = 'Сообщение, выводимое в случае недоступности сайта (когда выбран статус \'Оффлайн\') или в случае возникновения ошибки. <b>ПРИМЕЧАНИЕ:</b> это сообщение выводится только в том случае, когда не выбрана страница \'Сайт недоступен\'.';
$_lang["site_unavailable_message_default"] = 'В настоящее время сайт недоступен.';
$_lang["site_unavailable_page_message"] = 'Введите ID ресурса, который должны будут увидеть посетители, если попытаются зайти на сайт, когда он недоступен. <b>ПРИМЕЧАНИЕ:</b> убедитесь, что этот ID принадлежит существующему ресурсу, и что этот ресурс опубликован';
$_lang["site_unavailable_page_title"] = 'Страница \'Сайт недоступен\':';
...
$_lang["tree_page_click_title"] = 'Режим щелчка мышью на ресурсе';
...
$_lang["unauthorized_page_title"] = 'Страница \'Доступ запрещен\':';
...
$_lang["upload_files_message"] = 'Здесь вы можете указать, какие типы файлов могут быть загружены на сервер через файл-менеджер. Задайте список расширений через запятую.';
$_lang["upload_files_title"] = 'Разрешенные к загрузке файлы:';
$_lang["upload_flash_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в \'assets/flash/\' с помощью файл-менеджера. Введите расширения разрешенных типов флэш-файлов, разделяя их запятыми.';
$_lang["upload_flash_title"] = 'Разрешенные к загрузке flash-файлы:';
$_lang["upload_images_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в \'assets/images/\' с помощью файл-менеджера. Введите расширения разрешенных типов графических файлов, разделяя их запятыми.';
$_lang["upload_images_title"] = 'Разрешенные к загрузке изображения:';
$_lang["upload_media_message"] = 'Здесь вы можете ввести список файлов, которые могут быть загружены в \'assets/media/\' с помощью файл-менеджера. Введите расширения разрешенных типов медиа-файлов, разделяя их запятыми.';
$_lang["upload_media_title"] = 'Разрешенные к загрузке медиа-файлы:';
...
$_lang["webpwdreminder_message_message"] = 'Здесь вы можете создать сообщение, которое будет отсылаться пользователям, когда они запрашивают напоминание пароля. Письмо должно содержать имя пользователя и пароль. <br /><b>ПРИМЕЧАНИЕ.</b> Следующие \'поля вывода\' отобразят соответствующие данные при отправлении письма: <br /><br />[+sname+] - название сайта, <br />[+saddr+] - e-mail адрес сайта, <br />[+surl+] - адрес (URL) сайта, <br />[+uid+] - имя пользователя или id пользователя, <br />[+pwd+] - пароль пользователя, <br />[+ufn+] - полное имя пользователя. <br /><br /><b>Убедитесь, что в сообщении присутствуют поля [+uid+] и [+pwd+], иначе пользователь не узнает свои имя пользователя и пароль</b>';
$_lang["webpwdreminder_message_title"] = 'Напоминание пароля:';
$_lang["websignupemail_message_message"] = 'Здесь вы можете создать сообщение, которое будет отсылаться веб-пользователям, когда создается учетная запись нового веб-пользователя. Письмо должно содержать имя пользователя и пароль. <br /><b>ПРИМЕЧАНИЕ.</b> Следующие \'поля вывода\' отобразят соответствующие данные при отправлении письма: <br /><br />[+sname+] - название сайта, <br />[+saddr+] - e-mail адрес сайта, <br />[+surl+] - URL сайта, <br />[+uid+] - имя пользователя или id пользователя, <br />[+pwd+] - пароль пользователя, <br />[+ufn+] - полное имя пользователя. <br /><br /><b>Убедитесь, что в сообщении присутствуют поля [+uid+] и [+pwd+], иначе пользователь не узнает свои имя пользователя и пароль</b>';
$_lang["websignupemail_message_title"] = 'Регистрация веб-пользователя:';
...
$_lang['resource_tree_node_name_title'] = 'Название ресурса в дереве';
$_lang['resource_tree_node_name_message'] = 'Укажите поле документа, из которого выводить информацию в дерево ресурсов. По умолчанию pagetilte, можно использовать другое поле к примеру menutitle.';
$_lang['cache_type_title'] = 'Режим кеширования';
$_lang['cache_type_message'] = 'Выбор "Без Кеша" отключит все кеширование. Не рекомендуется';
...
$_lang["bkmgr_snapshot_msg"] = '<p>Содержимое базы данных сохраняются и восстанавливаются на сервер.<br />Путь для резервных копий: [+snapshot_path+] ($modx->config[\'snapshot_path\'])</p>';
...
$_lang["limit_by_container_title"] = 'Лимит для отображения документов в дереве ресурсов';
...
$_lang["docid_incrmnt_method_1"] = 'Минимальный пропущенный номер';
$_lang["docid_incrmnt_method_2"] = 'Максимальное значение (MAX)';
$_lang["docid_incrmnt_method_message"] = 'Метод увелиечния инентификатора ресурсов';

$_lang["base_url_title"] = 'Базовый URL';
...
$_lang['output_filter_title'] = 'Пост фильтры';
$_lang['output_filter_message'] = 'Использовать встроенный PHx, работают только модификаторы.';
...
$_lang["image_limit_width_title"] = 'Максимальная ширина загружаемых картинок';
$_lang["image_limit_width_message"] = 'Автоматически уменьшает ширину загруженных изображений. Если оставить пустым, то без ограничения.';
...
$_lang["update"] = 'Сохранить';

$_lang["manager_inline_style_title"] = 'Дополнительные стили';
$_lang["manager_inline_style_message"] = 'Дополнительные стили в системе управления';
...
$_lang['make_folders_title'] = 'Устанавливать завершающий слеш в URL для контейнеров';
$_lang['make_folders_message'] = 'Устанавливать завершающий слеш для ресурсов контейнеров (используется при включенных ЧПУ).';

$_lang["pwd_hash_algo_title"] = 'Алгоритм шифрования';
$_lang["pwd_hash_algo_message"] = 'Алгоритм шифрования паролей.';

$_lang["move_resource_cant_myself"] = 'Вы не можете переместить ресурс в дочерний ресурс!';

$_lang["topmenu_items_title"] = 'Структура верхнего меню';
$_lang["topmenu_items_message"] = 'Структура верхнего меню в системе управления';
...
$_lang["template_parent"] = 'Шаблон родителей';
...
$_lang['yes_full']="Да (полностью)";
$_lang['yes_stay']="Да (Stay mode)";

$_lang['settings_edit_title']="Редактировать настройки системы";
$_lang['settings_edit_new_tab_title']="Создать";
$_lang['new_tab_error'] = "Обязательное поле";
$_lang['new_tab_message'] = "Вы можете использовать как значение из язокового файла так и простой текст.";
$_lang['settings_group_edit_title']="Редактировать вкладку системных настроек";
$_lang['settings_group_field_title']="Редактировать параметр системных настроек";

$_lang['setting_name_title'] = "Название";
$_lang['setting_name_message'] = 'Данный параметр будет доступен для вывода в шаблонах и чанках как [(название параметра)] в снипетах как $modx->config["название параметра"]';

$_lang['setting_id_group_title'] = "Вкладка";
$_lang['setting_id_group_message'] = "На какой вкладке будет отображаться данный параметр";

$_lang['setting_title_title'] = "Наименование";
$_lang['setting_title_message'] = "Название поле на вкладке системных настроек. Вы можете использовать как значение из язокового файла так и простой текст.";

$_lang['setting_description_title'] = "Описание";
$_lang['setting_description_message'] = "Описание поле на вкладке системных настроек. Вы можете использовать как значение из язокового файла так и простой текст. ";

$_lang['setting_sort_title'] = "Позиция";
$_lang['setting_sort_message'] = "Порядковый номер";

$_lang['setting_options_title'] = "Конфигурация поля";
$_lang['setting_options_message'] = 'Описание как будет отображаться поле на вкладке системных настроек:<br/>
    тип поля[||параметры в зависимости от типа поля]<br/><br/><strong>стандартные типы полей</strong>:
    <ul>
    <li>text - текстовое поле</li>
    <li>text_lang - текстовое поле с подгрузкой значений по умолчанию из языковых файлов</li>
    <li>textarea - текстовое поле (textarea)</li>
    <li>text_lang - текстовое поле (textarea) с подгрузкой значений по умолчанию из языковых файлов</li>
    <li>select - выподающий список, формат: select||значение=заголовок;значение2=заголовок2 или select||значение1;значене2</li>
    <li>radio - радиобоксы, формат: radio||значение=заголовок;значение2=заголовок2[||depend||поле1,поле2,...]] depend - зависимые поля которые скрываются или показываются в зависимости от значения данного поля</li>
    </ul><br/>
    вы можете <strong>создавать свои типы полей</strong>, в данном случае подгружается файл /manager/includes/field_{ваш тип поля}.php список параметров доступен как массив $options
';
$_lang['setting_value_title'] = "Значение поле";
$_lang['setting_value_message'] = "задается на вкладке системных настроек";

$_lang['dublicate_setting_name_error'] = "Данное название уже используется";
$_lang['empty_setting_name_error'] = "Обязательное поле";
